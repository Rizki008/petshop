...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?= base_url() ?>backend/assets/" data-template="vertical-menu-template-free">
					...
					<div class="card-body">
						...
						<div class="app-brand justify-content-center">
							<a href="#" class="app-brand-link gap-2">
								...
								<span class="app-brand-text demo text-body fw-bolder">PETSHOP</span>
							</a>
						</div>
						<!-- /Logo -->
						...
						if ($this->session->flashdata('error')) {
							...
							</button><h5><i class="icon fa fa-ban"></i> Gagal</h5>
						</div>';
						...
						if ($this->session->flashdata('pesan')) {
							...
							'<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
							</button><h5><i class="icon fa fa-ban"></i> Success</h5>
						</div>';
						...
						?>
						<form id="formAuthentication" class="mb-3" action="<?= base_url('auth/user_login') ?>" method="POST">
							<div class="mb-3">
