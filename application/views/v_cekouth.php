				...
				<div class="col-md-7">
					...
					<div class="billing-details">
						...
						<div class="form-group">
							<input class="input" type="text" name="nama_pelanggan" value="<?= $this->session->userdata('nama'); ?>" readonly>
						</div>
						<div class="form-group">
							<input class="input" type="number" name="no_tlpn" value="<?= $this->session->userdata('no_tlpn'); ?>" readonly>
						</div>
						<div class="form-group">
							<input class="input" type="text" name="kode_pos" value="<?= $this->session->userdata('kode_post'); ?>" readonly>
						</div>
						<div class="form-group">
							<input class="input" type="text" name="alamat" value="<?= $this->session->userdata('alamat'); ?>" readonly>
						</div>
					</div>
					<!-- /Billing Details -->
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-3 col-xs-6">
						<div class="footer">
							<h3 class="footer-title">Tentang Pethsop</h3>
							<p>Toko Penjualan Makanan, penjualan hewan kucing dan jasa perawatan kucing</p>
							<ul class="footer-links">
								<li><a href="#"><i class="fa fa-map-marker"></i>Jl. Siliwangi No.13</a></li>
								<li><a href="#"><i class="fa fa-phone"></i>+62 897 1290 2918</a></li>
								<li><a href="#"><i class="fa fa-envelope-o"></i>pethsop@gmail.com</a></li>
							</ul>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12 text-center">
						...
						<span class="copyright">
							...
							</script> All rights reserved | Petshop <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						</span>
					</div>
				</div>
