			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				<div class="app-brand demo">
					<a href="index.html" class="app-brand-link">
						...
						<span class="app-brand-text demo menu-text fw-bolder ms-2">PetShop</span>
					</a>
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item active">
						<a href="<?= base_url('pemilik') ?>" class="menu-link">
					...
					<!-- <li class="menu-header small text-uppercase">
						<span class="menu-header-text">Master Produk</span>
					</li>
					<li class="menu-item">
					...
					<li class="menu-item">
						...
						<ul class="menu-sub">
							<li class="menu-item">
								<a href="<?= base_url('pemilik/laporan') ?>" class="menu-link">
